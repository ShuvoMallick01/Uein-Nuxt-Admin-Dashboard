...
export const useChartOptions = () => {
  const series = ref([
    { name: "Applications", data: [20, 30, 40, 50, 40, 30, 20] },
    { name: "Interviews", data: [30, 30, 30, 30, 30, 30, 30] },
    { name: "Rejections", data: [20, 20, 20, 20, 20, 20, 20] },
  ]);
  ...
  const chartOptions = useApexChartOptions({
    ...
    responsive: [
      ...
      },
      {
        ...
        options: {
          plotOptions: {
            bar: { borderRadius: 6, columnWidth: "25%" },
          },
        },
      },
      {
